...
mod tests
{
    use crate::multiplying_numbers_as_strings::MultString;

   
    #[test]
    fn test_plus()
    {
        let m1 = MultString{val : "1234567890".to_owned()};
        let m2 = MultString{val : "9876543210".to_owned()};
        let res = m1 + m2;
        println!("{}", res.val );
    ...
    fn test_mult()
    {
        ...
        let res = m1 * m2;
        assert_eq!(res.val, "444625839871840560024489175424316205566214109298");
